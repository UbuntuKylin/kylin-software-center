...
class Ui_Uktransliw(object):
    def setupUi(self, Uktransliw):
        ...
        self.transstatu = QtGui.QLabel(Uktransliw)
        ...
        self.btnDetail = QtGui.QPushButton(Uktransliw)
        ...
        self.translateDate = QtGui.QLabel(Uktransliw)
        ...
        self.appname = QtGui.QLabel(Uktransliw)
        ...
        self.appsummary = QtGui.QLabel(Uktransliw)
        ...
        self.appdescription = QtGui.QLabel(Uktransliw)
        ...
        self.namestatu = QtGui.QLabel(Uktransliw)
        ...
        self.summarystatu = QtGui.QLabel(Uktransliw)
        ...
        self.descriptionstatu = QtGui.QLabel(Uktransliw)
        ...
        self.status = QtGui.QLabel(Uktransliw)
